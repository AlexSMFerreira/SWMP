This internship is carried out within the scope of the SEAWINGS and AIRSHIP projects, initiatives aimed at developing innovative autonomous aerial platforms specifically designed to operate over maritime environments. The distinguishing feature of these platforms is their design as Wing-In-Ground (WIG) effect vehicles. These vehicles (Figure~\ref{fig:wig_effect}) stand out for flying at high speeds and extremely low altitudes compared to conventional aircraft, often only one or two metres above the water surface. This flight configuration takes advantage of the aerodynamic "ground effect" phenomenon, creating a cushion of air beneath the structure that drastically increases the vehicle's lift and energy efficiency.

\begin{figure}[h]
     \centering
          \includegraphics[width=0.7\textwidth]{wig}
